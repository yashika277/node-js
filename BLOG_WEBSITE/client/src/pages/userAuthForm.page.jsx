...
const UserAuthForm = ({ type }) => {
  ...
  const usertAuthThroughServer = (serverRoute, formData) => {
    axios
  ...
  const handleSubmit = (e) => {
    ...
    if (!emailRegex.test(email)) {
      return toast.error("Email is invalide");
    }
    ...
    usertAuthThroughServer(serverRoute, formData);
  };
