...
const PublishForm = () => {
  let characterLimit = 200; // Characters allowed in the description field
  let tagLimit = 10; // Number of tags allowed in a post
  ...
  // If the user presses enter, reject the enter
    ...
    <AnimationWrapper>
      <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
        ...
        <div className="max-w[550px] center">
          ...
          <h1 className="text-4xl font-medium mt-3 leading-tight line-clamp-2">{title}</h1>
